...
class Converter:
    def __init__(self):
        ...
        #Termperature Converter Heading (row 0)
        ...
        self.temp_instructions_label = Label(self.converter_frame, 
                                             text = ("Type in the amount to be converted and then push one of the buttons below"),
        ...
        #Conversions buttons frame (row 3), orchid3 and khaki1
        self.conversion_buttons_frame = Frame(self.converter_frame)
        self.conversion_buttons_frame.grid(row = 3, pady = 10)
        
        self.to_c_button = Button(self.conversion_buttons_frame,
                                  text = "To Centigrade", font = ("Arial", "10", "bold"), bg="Khaki1", 
                                  padx = 10, pady = 10,
                                  command = lambda: self.temp_convert(-459))
        self.to_c_button.grid(row = 0, column = 0)
        
        self.to_f_button =  Button(self.conversion_buttons_frame,
                                  text = "To Fahrenheit", font = ("Arial", "10", "bold"), bg="Orchid1", 
                                  padx = 10, pady = 10,
        ...
        self.history_button = Button(self.hist_help_frame, font = ("Arial", "12", "bold"),
                                       text = "Calculation History", width = 15,  command = lambda: self.history(self.all_calc_list))
    ...
    def help(self):
        ...
        get_help.help_text.configure(text = "Please enter a number in the box "
                                     ...
                                     "either to convert the number to either "
                                     ...
                                     "history to a text file if desired.") #The \n\n give a new paragraph
